...
io.on('connection', (socket) => {
  ...
  socket.on('power-king-select', withRoom((room, playerId, p) => room.usePowerKingSelect(playerId, p.a, p.b)));
  socket.on('power-king-decide', withRoom((room, playerId, p) => room.usePowerKingDecide(playerId, !!p.swap)));
